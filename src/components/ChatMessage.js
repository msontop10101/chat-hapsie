...
const ChatMessage = ({ message }) => {
  return (
    <>
          <div className={`${message.user === 'gpt' ? 'flex flex-row md:flex-col justify-start items-center my-1 rounded-xl' : 'flex flex-row md:flex-col-reverse justify-end items-center my-1 rounded-xl'}`}>
